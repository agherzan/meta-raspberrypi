...
PACKAGECONFIG ??= "avdevice avfilter avcodec avformat swresample swscale postproc avresample opengl udev v4l2 \
                   sdl2 ffplay alsa bzlib lzma pic pthreads shared theora zlib snappy libopus libvorbis vpx \
                   x264 gpl mmal sand rpi vout-drm vout-egl \
